    ...
    <div>
      ...
      <div style={{ marginBottom: '2rem' }}>
        ...
        <p style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>
          Review partner onboarding, approve verified facilities, and configure 10%–15% commission tier structures.
        </p>
      </div>
                ...
                shops.map((s) => (
                  <tr key={s.id}>
                    <td>
                      ...
                      <div style={{ fontSize: '0.78rem', color: 'var(--text-muted)' }}>Rating ★ {s.rating || 4.8} ({s.totalRatings || 120} reviews)</div>
                    </td>
                    <td>
                      <div style={{ fontSize: '0.85rem', color: 'var(--text-primary)', fontWeight: 600 }}>{s.ownerName || 'Rajesh Verma'}</div>
